...
class SymmetricProcessor(Processor):
    ...
    #     try:
    #         return np.concatenate([action[0][0], action[1][0]], axis=0)
    #     except IndexError:
...
class DDPGSymmetricAgentDualActorOutput(Agent):
    ...
    def __init__(self, nb_actions, actor, critic,
        ...
        super(DDPGSymmetricAgentDualActorOutput, self).__init__(**kwargs)
    ...
    def compile(self, optimizer, metrics=[]):
        ...
        actions = self.actor(self.actor_inputs)
    ...
    def backward(self, reward, terminal=False):
        ...
        if can_train_either and self.step % self.train_interval == 0:
            ...
            if self.step > self.nb_steps_warmup_critic:
                ...
                target_actions_right = target_actions[0]
                target_actions_left = target_actions[1]
